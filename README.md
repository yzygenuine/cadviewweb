...
- `index.html`: Landing page (features + screenshots + download link)
- `privacy_policy.html`: English Privacy Policy (static content)
- `user_agreement.html`: English User Agreement (static content)
- `pics/`: App icon and iPhone/iPad screenshots used on the landing page
